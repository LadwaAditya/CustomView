...
//			System.out.printf("%d, %f\n", progress, mProgressSweep);
    ...
    public interface OnSwagPointsChangeListener {
         ...
         */
        void onPointsChanged(SeekBar swagPoints, int points, boolean fromUser);

        void onStartTrackingTouch(SeekBar swagPoints);

        void onStopTrackingTouch(SeekBar swagPoints);
    }
